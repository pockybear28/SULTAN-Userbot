...
async def killdabot(event):
    ...
    await event.edit("`Mematikan SULTAN-Userbot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#SHUTDOWN \n" "**SULTAN-Userbot Telah Dimatikan**"
        )
...
async def killdabot(event):
    await event.edit("`Restarting SULTAN-Userbot...`")
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTARTBOT \n" "**SULTAN-Userbot Telah Di Restart**"
        )
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Userbot Repo](https://github.com/pockybear28/SULTAN-Userbot/blob/SULTAN-Userbot/README.md)"
        "\n[Setup Guide - Basic](https://telegra.ph/TUTORIAL-BIKIN-BOT-05-21)"
...
async def repo_is_here(wannasee):
    """For .repo command, just returns the repo URL."""
    await wannasee.edit(
        f"✥ **GET STRING SESSION TELEGRAM :** [KLIK DISINI](https://t.me/userbotmaker) Terus ketik #string\n"
    )
...
CMD_HELP.update(
    {
        "sleep": "**Plugin : **`sleep`\
        \n\n  •  **Syntax :** `.sleep`\
        \n  •  **Function : **Biarkan SULTAN-Userbot tidur selama beberapa detik \
    "
    }
)
...
CMD_HELP.update(
    {
        "repo": "**Plugin : **`Repository SULTAN-Userbot`\
        \n\n  •  **Syntax :** `.repo`\
        \n  •  **Function : **Menampilan link Repository SULTAN-Userbot\
        \n\n  •  **Syntax :** `.string`\
        \n  •  **Function : **Menampilan link String SULTAN-Userbot\
    "
    }
)
...
CMD_HELP.update(
    {
        "restart": "**Plugin : **`Restart SULTAN-Userbot`\
        \n\n  •  **Syntax :** `.restart`\
